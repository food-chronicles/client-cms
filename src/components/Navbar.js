  ...
  <div className="hidden lg:flex lg:items-center lg:w-auto w-full" id="menu">
    <nav>
      <ul className="lg:flex items-center justify-between text-base text-gray-700 pt-4 lg:pt-0">
        ...
        <li><Link to='/login' className="lg:p-4 py-3 px-0 block border-b-2 border-transparent text-blue-900 hover:border-blue-900" >Login</Link></li>
        <li><Link to='/create' className="lg:p-4 py-3 px-0 block border-b-2 border-transparent text-blue-900 hover:border-blue-900" >Create</Link></li>
        <li><Link to='/scan' className="lg:p-4 py-3 px-0 block border-b-2 border-transparent text-blue-900 hover:border-blue-900" >Scan</Link></li>
      </ul>
    </nav>
